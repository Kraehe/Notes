...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { desc: @folder.desc, image_url: @folder.image_url, name: @folder.name, visible: @folder.visible }
    end
  ...
  test "should update folder" do
    patch :update, id: @folder, folder: { desc: @folder.desc, image_url: @folder.image_url, name: @folder.name, visible: @folder.visible }
    assert_redirected_to folder_path(assigns(:folder))
  end
